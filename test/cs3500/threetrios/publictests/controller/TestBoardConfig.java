...
public class TestBoardConfig {
  @Test
  public void test1() {
    System.out.println(GridConfig.fileToGridBoard(TestFiles.GRID_ASSN_HARD));
    ...
    Assert.assertEquals(expected, GridConfig.fileToGridBoard(TestFiles.GRID_ASSN_HARD));
  }
}
